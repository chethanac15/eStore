      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">Subscribe to our newsletter for the latest deals and products.</p>
            <div className="flex">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-3 py-2 bg-gray-700 text-white rounded-l-md focus:outline-none focus:ring-2 focus:ring-primary-indigo"
              />
              <button className="bg-primary-indigo px-4 py-2 rounded-r-md hover:bg-electric-blue transition-colors">
                Subscribe
              </button>
            </div>
          </div>
